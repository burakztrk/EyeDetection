...
import com.mobelm.eyedetection.ui.camera.CameraSourcePreview;
...
public final class GooglyEyesActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        leftButton = findViewById(R.id.leftEyeButton);
        rightButton = findViewById(R.id.rightEyeButton);
    ...
    private FaceDetector createFaceDetector(final Context context) {
        ...
        final EyeListener leftEyeListener = new EyeListener() {
            @Override
            public void onBlink(final boolean isOpened) {
                leftButton.post(new Runnable() {
                    @Override
                    public void run() {
                        leftButton.setText(isOpened ?"OPEN" : "CLOSE");
                    }
                });
        ...
        final EyeListener rightEyeListener = new EyeListener() {
            @Override
            public void onBlink(final boolean isOpened) {
                rightButton.post(new Runnable() {
                    @Override
                    public void run() {
                        rightButton.setText(isOpened ?"OPEN" : "CLOSE");
                    }
                });
        ...
        if (mIsFrontFacing) {
            ...
            // face position.
            GooglyFaceTracker tracker = new GooglyFaceTracker(mGraphicOverlay).setEyeListener(leftEyeListener,rightEyeListener);
            ...
            MultiProcessor.Factory<Face> factory = new MultiProcessor.Factory<Face>() {
                ...
                public Tracker<Face> create(Face face) {
                    return new GooglyFaceTracker(mGraphicOverlay).setEyeListener(leftEyeListener,rightEyeListener);
                }
            };
